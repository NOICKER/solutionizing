...
// Wait, depending on prettier it might be 2 spaces:
const searchStr2 = `  return (\n  <div className="min-h-screen bg-[var(--bg)] pb-12">\n  <div className="mx-auto max-w-2xl px-4 sm:px-6 md:px-8 transition-all duration-300 pt-6">`;

let split1 = content.split(searchStr1);
let searchStr = searchStr1;
if (split1.length < 2) {
  split1 = content.split(searchStr2);
...
`;
      ...
      // Let's make the replacement robust against spaces
