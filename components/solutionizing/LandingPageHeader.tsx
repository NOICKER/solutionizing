      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex h-20 items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg border border-primary bg-primary text-white shadow-lg shadow-primary/20 sm:h-10 sm:w-10">
              <span className="material-symbols-outlined text-xl font-bold sm:text-2xl">analytics</span>
            </div>
